...
import com.saurabh.mynotes.adapter.NoteAdapter
import com.saurabh.mynotes.databinding.FragmentEditNoteBinding
...
class EditNoteFragment : Fragment(R.layout.fragment_edit_note), MenuProvider {
    ...
    private fun deleteNote() {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE)?.setTextColor(ContextCompat.getColor(requireContext(), R.color.red)) // Replace 'red' with your desired color resource
        dialog.getButton(AlertDialog.BUTTON_NEGATIVE)?.setTextColor(ContextCompat.getColor(requireContext(), R.color.gray)) // Replace 'gray' with your desired color resource
    }
